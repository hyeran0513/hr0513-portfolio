export const projects = [
  ...
  },
  {
    ...
    review: 'SAASDA 서비스 홈페이지의 소개 페이지에서 PC 작업은 다른 프론트엔드 분과 함께 진행했고, 반응형 작업을 전담했으며, Swiper.js와 VueUse 등의 라이브러리를 활용해 개발을 진행했습니다. 애니메이션 SCSS를 적용하여 페이지에 입체감을 더했습니다.'
  },
  {
    thumb: 'saasda.png',
    ...
    review: '웹 페이지의 유지보수와 기능 추가 작업을 담당했습니다. 레드마인을 통해 결함을 확인하고 처리했으며, 기능에 문제가 발생할 경우 히스토리를 확인하고 기획 변경 여부를 점검하여 문제를 해결했습니다.'
  },
  {
    thumb: 'hdream.png',
    projectName: '하남 커리어넷',
